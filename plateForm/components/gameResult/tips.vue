<template>
    <div class="maskCon pf pr" v-if="isShow" id="maskCon" ref="maskCon">
            ...
            <div class="container tac">
              <div>
                ...
                <div class="inContent tal pr"  v-show="isSlect6" :class="{active: isSlect7}">
                  <p class="f16 margin pr">根据规则调整游戏房间设置 <b class="pa cp">比赛规则</b></p>
        ...
        <div v-show="tips2" class="inMaskCon tips2Con pa center pr tac">
          <div class="closeIcon pa f18 cp" @click="closeFn">×</div>
          <h5 class="f20">游戏即将开始</h5>
          <div class="inCon f14">
            <div class="">
              <p class="time">倒计时</p>
...
<script>
export default {
    props:['gameRoomName','gameRoomPwd','startCountDown'],
    data(){
        return{
            isShow:true,
            date:'',
