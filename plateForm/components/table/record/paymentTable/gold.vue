    ...
    <div class="table" ref="table">
        ...
        <div class="table-body">
            <div class="row"
                ...
                :key="index">
                <div>
                    <span v-text="formatDate(item.createTime)" :title="item.createTime"></span>
                </div>
                <div>
                ...
                <div>
                    <span v-if="item.tradeType==1"
                        class="red"
                        v-text="'-'+item.goldAmount"></span>
                    <span  v-if="item.tradeType==2"
                        class="green"
                        v-text="'+'+item.goldAmount"></span>
                </div>
                <div v-text="item.goldAfterAmount"
                    :title="item.goldAfterAmount"></div>
            </div>
        </div>
...
import { getRecordGold } from '@/request/order'
